...
import com.sparkout.chat.ui.attachment.util.toPx
import kotlin.math.sqrt

class SoftKeyBoardPopup(private val context: Context,
                        private val rootView: ViewGroup,
                        private val editText: EditText,
                        private val anchorView: View,
                        private val triggerView: View) : PopupWindow(context),
    ...
    override fun onGlobalLayout() {
        ...
        val heightDifference = screenHeight - windowHeight

        if (heightDifference > KEYBOARD_OFFSET) {
            keyboardHeight = heightDifference + windowRect.top
