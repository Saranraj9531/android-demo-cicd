...
class ChatAdapter(
    ...
    val chatClickOptions: ChatClickOptions,
    ...
    fun updateMessageListItems(
        ...
        val diffCallback =
            MessageDiffCallback(this.listChat, messageList, locChatModel, true)
        ...
        when (getItemViewType(position)) {
            ...
            ChatMessageTypes.AUDIO.type.toInt() -> {
                ...
                if (listChat[audioHolder.adapterPosition].sender == SharedPreferenceEditor.getData(
                    ...
                    /*if (listChat[audioHolder.adapterPosition].isPlaying) {
                        Log.e("TAG", "onBindViewHolder: PausePosition 1" )
                        audioHolder.imageViewPlaySentAudio.setImageDrawable(context.resources.getDrawable(
                            R.drawable.ic_audio_pause))
                    } else {
                        audioHolder.imageViewPlaySentAudio.setImageDrawable(context.resources.getDrawable(
                            R.drawable.ic_audio_play))
                    }
                    audioHolder.seekarBarSentAudio.progress = 0
                    val mTime =
                        getLocalTime(listChat[audioHolder.adapterPosition].chatTime.toLong())
                    audioHolder.textViewAudioSentTime.text = getTime(mTime)*/
                } else {
            ...
            ChatMessageTypes.VIDEO.type.toInt() -> {
                ...
                if (listChat[position].sender == SharedPreferenceEditor.getData(USER_ID)) {
                    ...
                    if (null != loadVideoPath(listChat[position].messageId)) {
                        Glide.with(context).setDefaultRequestOptions(requestOptionsTv()!!)
                            .load(loadVideoPath(listChat[position].messageId))
            ...
            ChatMessageTypes.IMAGE.type.toInt() -> {
                ...
                if (listChat[position].sender == SharedPreferenceEditor.getData(USER_ID)) {
                    ...
                    if (null != loadImagePath(listChat[position].messageId)) {
                        Glide.with(context).setDefaultRequestOptions(requestOptionsT()!!)
                            .load(loadImagePath(listChat[position].messageId))
            ...
            ChatMessageTypes.DOCUMENT.type.toInt() -> {
                ...
                if (listChat[position].sender == SharedPreferenceEditor.getData(USER_ID)) {
                    ...
                    documentHolder.layoutSentDocument.setOnClickListener(object :
                        View.OnClickListener {
                        override fun onClick(v: View?) {
                            chatClickOptions.documentOptions(listChat[documentHolder.adapterPosition])
                        }
                    })
                    val mTime = getLocalTime(listChat[position].chatTime.toLong())
            ...
            ChatMessageTypes.LOCATION.type.toInt() -> {
                ...
                if (locationData.isNotEmpty()) {
                    mMapUrl =
                        getStaticMap(
                            context, locationData[0].latitude.toString()
                                .plus(",")
                                .plus(locationData[0].longitude.toString())
                        )!!
                } else if (listChat[position].latitude != 0.0) {
                    mMapUrl =
                        getStaticMap(
            ...
            ChatMessageTypes.DATE.type.toInt() -> {
                ...
                Log.e("Nive ", "onBindViewHolder:Date " + position)
            ...
            ChatMessageTypes.DELETEFOREVERYONE.type.toInt() -> {
                val deletedMessageViewHolder = holder as ChatAdapter.DeletedMessageViewHolder
                if (listChat[position].sender == SharedPreferenceEditor.getData(USER_ID)) {
    ...
    inner class AudioViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        /* val textViewReceivedAudioSlash: AppCompatTextView =
             itemView.findViewById(R.id.textview_slash_in)*/
