package com.sparkout.chat.musicplayer.media
...
import com.sparkout.chat.musicplayer.factory.Factory
...
internal class MediaService : Service(), Playback.ServiceCallback {
    ...
    override fun onStartCommand(startIntent: Intent?, flags: Int, startId: Int): Int {
        if (startIntent != null) {
            ...
            when {
                extras != null -> notificationManager.setIntent(extras.getParcelable(EXTRA_INTENT))
