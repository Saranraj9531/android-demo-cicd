...
//        bitmap.recycle();
    ...
    public static Intent getPickImageChooserIntent(
        ...
        Log.e("Nivi ", "getPickImageChooserIntent:check " + isExplicitCameraPermissionRequired(context));
        Log.e("Nivi ", "getPickImageChooserIntent:include " + includeCamera);
        ...
        Log.e("Nivi ", "getPickImageChooserIntent:All " + allIntents);
    ...
    public static Uri getCaptureImageOutputUri(@NonNull Context context) {
        ...
        if (CommonVersionCheck.INSTANCE.isAtLeastQ29()) {
            ...
            try {
                ...
                Log.e("Nivi ", "getCaptureImageOutputUri:try " + outputFileUri);
            } catch (Exception e) {
                outputFileUri = Uri.fromFile(new File(getImage.getPath(), "pickImageResult.jpeg"));
                Log.e("Nivi ", "getCaptureImageOutputUri:catch " + outputFileUri);
            }
