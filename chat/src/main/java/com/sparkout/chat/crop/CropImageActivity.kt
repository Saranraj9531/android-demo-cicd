package com.sparkout.chat.crop
...
import com.sparkout.chat.crop.common.CommonValues
import com.sparkout.chat.crop.common.CommonVersionCheck
import com.sparkout.chat.databinding.CropImageActivityBinding
import java.io.File
...
class CropImageActivity :
    ...
    public override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            if (cropImageUri == null || cropImageUri == Uri.EMPTY) {
                Log.e("Nive ", "onCreate:isExplicitCameraPermissionRequired "+CropImage.isExplicitCameraPermissionRequired(this))
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CropImage.PICK_IMAGE_CHOOSER_REQUEST_CODE) {
            if (resultCode == RESULT_CANCELED) {
                Log.e("Nive ", "onActivityResult: Result Canclled")
                setResultCancel()
            }
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == CropImage.CAMERA_CAPTURE_PERMISSIONS_REQUEST_CODE) {
            ...
            Log.e("Nive ", "onRequestPermissionsResult:CropImage Code ")
            CropImage.startPickImageActivity(this)
        }
    }
    ...
    override fun onCropImageComplete(view: CropImageView, result: CropImageView.CropResult) {
        Log.e("Nive ", "onCropImageComplete: ")
    ...
    private val outputUri: Uri?
        get() {
            ...
            Log.e("Nive ", ":OutPutUri CropImageActivity $outputUri")
            if (outputUri == null || outputUri == Uri.EMPTY) {
                outputUri = try {
                    ...
                    if (CommonVersionCheck.isAtLeastQ29()) {
                        try {
                            /* var path = File.createTempFile(
                                 "cropped",
                                 ext,
                                 getExternalFilesDir(Environment.DIRECTORY_PICTURES))
                             Log.e("Nive ", ":Temp Path ${path.absolutePath}")
 */
